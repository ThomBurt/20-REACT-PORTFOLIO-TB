    ...
    return (
        <div className="portfolio" id="portfolio">
            ...
            <div className="container">
                ...
                <img src={dinnerSpinner} alt="dinnerSpinner" style={{ width: "250px" }}></img>
                </a>
            ...
            <div className="container">
                ...
                <img src={plantPal} alt="Plant Pal" style={{ width: "250px" }}></img>
                </a>
                <h3>Plant Pal</h3>
            </div>
            ...
            <div className="container">
                <a href="https://thomburt.github.io/weather-dashboard-TB/">
                  <img src={weather} alt="weather" style={{ width: "250px" }}></img>
                </a>
                <h3>Weather App</h3>
            </div>
            ...
            <div className="container">
                <a href="https://vast-lake-01153.herokuapp.com/">
                    <img src={songwritersLounge} alt="songwritersLounge" style={{ width: "250px" }}></img>
                </a>
